 ...
 *
 * Memakai default browser context (incognito bikin koneksi CDP putus
 * di Vercel), jadi cookie dibersihkan antar-request di route agent.
 * ============================================================ */
...
async function newPage() {
  // Pakai default context (bukan incognito) — createBrowserContext
  // membuat koneksi CDP putus di Vercel serverless.
