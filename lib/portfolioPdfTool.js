...
const analyzeWebsiteTool = {
  ...
  function: {
    ...
    description:
      'Buka URL website pakai browser server (bukan sandbox AI) lalu ambil judul, deskripsi, heading, cuplikan teks, screenshot, status HTTP, waktu load, mobile-friendly, dan error console. Pakai saat user minta portofolio/laporan dari URL. Setelah hasil masuk, rangkum fitur website dengan katamu sendiri, lalu panggil generate_portfolio_pdf. Jika ok:false, beri tahu user — jangan mengarang data.',
    parameters: {
      type: 'object',
      properties: {
...
const generatePortfolioPdfTool = {
  ...
  function: {
    ...
    description:
      'Buat PDF portofolio dari data yang sudah terkumpul (nama, jabatan, ringkasan, skill, pengalaman, proyek, pendidikan, kontak). Panggil hanya setelah data penting lengkap; jangan mengarang data.',
    parameters: {
      type: 'object',
      properties: {
        ...
        tagline: { type: 'string', description: 'Kalimat singkat value utama' },
        email: { type: 'string' },
        phone: { type: 'string' },
        ...
        projects: {
          ...
          items: {
            ...
            properties: {
              ...
              screenshot: {
                type: 'string',
                description: 'Opsional: base64 screenshot dari hasil analyze_website.',
              },
            },
            required: ['name'],
          },
        ...
        accentColor: {
          type: 'string',
          description: 'Hex warna aksen, mis. #6366F1. Opsional.',
        },
      },
      required: ['name', 'title'],
    },
