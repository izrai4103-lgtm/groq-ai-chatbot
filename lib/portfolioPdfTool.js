...
const generatePortfolioPdfTool = {
  ...
  function: {
    ...
    description:
      'Buat PDF portofolio dari data yang terkumpul (nama, jabatan, skill, pengalaman, proyek, kontak). Panggil setelah data lengkap; jangan mengarang.',
    parameters: {
      type: 'object',
      properties: {
        name: { type: 'string', description: 'Nama lengkap' },
        title: { type: 'string', description: 'Jabatan' },
        tagline: { type: 'string', description: 'Tagline singkat' },
        email: { type: 'string' },
        phone: { type: 'string' },
        ...
        projects: {
          ...
          items: {
            ...
            properties: {
              ...
              screenshot: {
                type: 'string',
                description: 'base64 screenshot dari analyze_website (opsional)',
              },
            },
            required: ['name'],
          },
        ...
        accentColor: {
          type: 'string',
          description: 'Hex warna aksen (opsional)',
        },
      },
      required: ['name', 'title'],
    },
