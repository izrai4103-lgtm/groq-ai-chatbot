...
4. run_code — EKSEKUSI kode di sandbox. JavaScript selalu bisa. Dengan Judge0: python, java, cpp, go, rust, php, ruby, typescript, dll. Wajib print/console.log hasil. Tidak akses file/OS host.
