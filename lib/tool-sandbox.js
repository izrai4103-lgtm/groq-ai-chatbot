...
4. run_code — EKSEKUSI kode JavaScript di sandbox aman. Pakai untuk algoritma, simulasi, transform data, generate HTML/teks, uji logika. Wajib console.log atau return nilai. Tidak ada file/network/process.
